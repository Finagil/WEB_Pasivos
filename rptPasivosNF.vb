...
Public Class rptPasivosNF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WEB_Finagil.rptPasivosNF.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_var_dia() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptPasivosNF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPasivosNF = New rptPasivosNF()
        rpt.Site = Me.Site
        Return rpt
    End Function
